            ...
            <header class="navbar navbar-default navbar-fixed-top">
                <div class="container">
                    <div class="navbar-header">
                        <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#header-collapse"><span class="icon-bar"></span><span class="ico n-bar"></span><span class="icon-bar"></span></button>
            ...
            <div class="container">
                <div class="navbar-header">
                    ...
                    <p class="navbar-text">
                        ...
                        <span class="text-muted"> | Phalcon {{ version() }} | PHP {{ phpversion() }} | SAPI {{ php_sapi_name() }}</span>
                    </p>
                </div>
