...
<html lang="{{ substr(i18n.lang(), 0, 2) }}">
    <head>
        ...
        {{ stylesheetLink('libs/bootstrap/css/bootstrap.min.css') }}
        {{ stylesheetLink('css/font-awesome.min.css') }}
        {{ assets.outputCss() }}
    </head>
    <body class="text-center" style="background: #f1f1f1">
        <br />
        <h1>{{ __('Error :code', [':code' : 404]) }}</h1>
        <h2 class="text-info"><i class="fa fa-times" aria-hidden="true"></i></h2>
