...
class Users extends \Phalcon\Mvc\Model
{
    ...
    public function activation()
    {
        if ($this->getRole()) {
            ...
            if ($role->create() === true) {
                ...
                \Ashanty\Bootstrap::log($this->getMessages());
    ...
    {
        $validation = new \Ashanty\Extension\Validation();

        $validation->add('username', new \Phalcon\Validation\Validator\PresenceOf());
        $validation->add('username', new \Ashanty\Extension\Uniqueness(array(
            'model' => '\Ashanty\Models\Users',
        )));
        ...
        $validation->add('email', new \Ashanty\Extension\Uniqueness(array(
            'model' => '\Ashanty\Models\Users',
        )));
        ...
        if (count($messages)) {
            ...
            if ($this->create() === true) {
                ...
                if ($email->Send() === true) {
                    ...
                    \Ashanty\Bootstrap::log($email->ErrorInfo);
                    return false;
                }
            } else {
                \Ashanty\Bootstrap::log($this->getMessages());
