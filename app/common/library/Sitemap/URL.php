...
class URL implements \Ashanty\Library\Sitemap\SitemapInterface
{
    ...
    public function set_loc($location)
    {
        ...
        $location = \Ashanty\Library\Sitemap::encode($location);
    ...
    {
        $this->attributes['lastmod'] = \Ashanty\Library\Sitemap::date_format($lastmod);
     ...
     * @param <type> $driver
     */
    public function __construct(\Ashanty\Library\Sitemap\SitemapInterface $driver = null)
    {
        $this->driver = $driver;
    }
