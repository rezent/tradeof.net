...
class Video implements \Ashanty\Library\Sitemap\SitemapInterface
{
    ...
    {
        $this->_attributes['expiration_date'] = \Ashanty\Library\Sitemap::date_format($expiration_date);
    }
    ...
    {
        $this->_attributes['publication_date'] = \Ashanty\Library\Sitemap::date_format($publication_date);
    }
